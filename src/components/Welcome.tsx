    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-screen text-center p-6 bg-linear-to-b from-green-100 to-white'>
            ...
            >
                ...
                <h1 className='text-4xl md:text-5xl font-extrabold text-green-700'>GreenShop</h1>
            ...
            >
                Your final destination for fresh salads ,groceries,organic produce and daily essentials right at your doorstep
            </motion.p>
            <motion.div
            ...
            >
                ...
                <Bike className='w-24 h-24 md:w-32 md:h-32 text-yellow-500 drop-shadow-md' />
            </motion.div>
