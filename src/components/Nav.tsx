"use client"
import { Boxes, ClipboardCheck, LogOut, Menu, Package, PlusCircle, Search, SearchIcon, ShoppingCartIcon, User, X } from 'lucide-react'
        ...
        <AnimatePresence>
            ...
            >
                <div className='flex justify-between items-center mb-2'>
                    ...
                    <button className='text-white/90 hover:text-red-400 text-2xl font-bold transition' onClick={() => setMenuOpen(false)}><X /></button>
                </div>
            ...
            <div className='flex items-center gap-3  md:gap-6 relative'>
                ...
                {user.role == "admin" &&
                    <>
                        ...
                        <div className='md:hidden bg-white rounded-full w-10 h-10 flex items-center justify-center' onClick={() => setMenuOpen((prev) => !prev)}>
                            ...
                            >
                                <div className='flex items-center gap-3 px-3 py-2 border-b border-gray-100'>
                                    <div className='w-10 h-10 relative rounded-full bg-green-100 flex items-center justify-center overflow-hidden '>
                                        {user.image ? <Image width={40} height={40} src={user.image} alt='user' className='object-cover rounded-full ' /> : <User />}
                                    </div>
                                    <div>
                        ...
                        {searchbarOpen
                            ...
                            >
                                ...
                                <button onClick={() => setSearchbarOpen(false)}>
                                    <X className='text-gray-500 w-5 h-5 hover:text-gray-700 cursor-pointer' />
                                </button>
                            </motion.div>
                        }
                    </AnimatePresence>
