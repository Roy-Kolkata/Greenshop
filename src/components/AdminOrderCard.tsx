        ...
        >
            <div className='flex flex-col md:flex-row md:items-start md:justify-between gap-4'>
                <div className='space-y-1'>
                    <p className='text-lg font-bold flex items-center  gap-2'>Order
                        <Package size={20} className=' text-green-700' />
                        <span className='text-lg font-bold flex items-center  gap-2 text-green-700'>  #{order._id?.toString()}</span>
                    </p>
                ...
                <div className='flex flex-col items-start md:items-end gap-2'>
                    ...
                    <select className='border border-gray-300 rounded-lg px-4 py-1 text-sm shadow-sm hover:border-green-400 transition  focus:ring-2 focus:ring-green-500 outline-none'>
